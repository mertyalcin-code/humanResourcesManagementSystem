...
public class FLGKPSPublicSoap {
    ...
    public FLGKPSPublicSoap() {
    }

    public FLGKPSPublicSoap(String url) {
        this.url = url;
    }

    public FLGKPSPublicSoap(String url, int timeOut) {
        this.url = url;
    ...
    protected FLGExtendedSoapSerializationEnvelope createEnvelope() {
        FLGExtendedSoapSerializationEnvelope envelope = new FLGExtendedSoapSerializationEnvelope(FLGExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;

        return envelope;
    }

    protected java.util.List sendRequest(String methodName, FLGExtendedSoapSerializationEnvelope envelope, org.ksoap2.transport.Transport transport, com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception {
    ...
    java.lang.Object getResult(java.lang.Class destObj, java.lang.Object source, String resultName, FLGExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception {
        if (source == null) {
            return null;
        }
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo, final String Ad, final String Soyad, final Integer DogumYili) throws java.lang.Exception {
        ...
        return (Boolean) execute(new FLGIWcfMethod() {
            @Override
            public FLGExtendedSoapSerializationEnvelope CreateSoapEnvelope() {
                FLGExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(FLGExtendedSoapSerializationEnvelope __envelope, java.lang.Object __result) throws java.lang.Exception {
    ...
    protected java.lang.Object execute(FLGIWcfMethod wcfMethod, String methodName, com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception {
        org.ksoap2.transport.Transport __httpTransport = createTransport();
        __httpTransport.debug = enableLogging;
        FLGExtendedSoapSerializationEnvelope __envelope = wcfMethod.CreateSoapEnvelope();
        try {
