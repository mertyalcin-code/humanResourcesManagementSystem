...
public class FLGKPSPublicSoap12 {
    ...
    public FLGKPSPublicSoap12(String url, int timeOut) {
        this.url = url;
    ...
    protected FLGExtendedSoapSerializationEnvelope createEnvelope() {
        FLGExtendedSoapSerializationEnvelope envelope = new FLGExtendedSoapSerializationEnvelope(FLGExtendedSoapSerializationEnvelope.VER12);
